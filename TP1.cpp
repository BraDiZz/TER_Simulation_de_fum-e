...
// je veux savoir commemnt remplir le tableau des coordonnées ...
...
int main( void )
{
    ...
    do{
        ...
        if(currentMesh==0){
            ...
            if(generate){
                for(int i=0;i<nbParticule;i++){
                    ...
                    uvs.push_back(glm::vec2(0.0f, 1.0f)); // Coin supérieur gauche
                    uvs.push_back(glm::vec2(1.0f, 1.0f)); // Coin supérieur droit
                    uvs.push_back(glm::vec2(1.0f, 0.0f)); // Coin inférieur droit
                    uvs.push_back(glm::vec2(0.0f, 0.0f)); // Coin inférieur gauche
                }
            }
       ...
       // Mettre à jour les données des particules
        ...
        glDrawArrays(GL_POINTS, 0, uvs.size());
